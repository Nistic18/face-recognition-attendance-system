...
class Ui_Dialog(QDialog):
    ...
    def runSlotAdmin(self):
        ...
        print(self.Videocapture_)
        ui.hide()  # hide the main window
        self.outputWindowAdmin_()  # Create and open new output window

    def outputWindowAdmin_(self):
        """
        Created new window for visual output of the video in GUI
        """
        from adminportal import Ui_Admin  # Import here to break circular dependency
        self._new_window = Ui_Admin()
        self._new_window.show()
        self._new_window.startVideo(self.Videocapture_)
